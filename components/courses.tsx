  ...
  const activeCourses = [
    {
      ...
      features: isRTL
        ? [
            "تحسين مهارات المحادثة، الاستماع، القراءة، والكتابة",
            "بناء مفردات وقواعد قوية بطريقة عملية",
            "تطوير النطق والطلاقة بشكل أوضح",
            "التدريب على مواقف تواصل حقيقية",
            "دروس تفاعلية تضع الطالب في قلب التجربة",
            "مناسب للمتعلمين في المستوى الابتدائي A2",
          ]
        : [
    ...
    },
    {
      ...
      features: isRTL
        ? [
            "إجراء محادثات طبيعية تصل إلى 20 دقيقة",
            "تحسين النطق من خلال تقنيات shadowing",
            "بناء مفردات متقدمة للطلاقة في الحديث",
            "تطوير مهارة الاستماع من خلال أنشطة غامرة",
            "ممارسة تفاعلية تساعدك على الكلام بثقة",
            "ملاحظات شخصية تساعدك على التحسن المستمر",
          ]
        : [
